      ...
      <div className="row mb-5 mt-5">
        <div className="col">
         <div className="image-container">
          ...
          <img src="../src/assets/alexia_chair_ls.webp" alt="image2" className='img-chair top-img' />
        ...
        <div className="col">
          ...
          <img src="../src/assets/charlotte-chair-ls.webp" alt="image2" className='img-chair top-img' />
        ...
        <div className="col">
          ...
          <img src="../src/assets/wallie_chair_ls.webp" alt="image1" className='img-chair top-img'/>
        ...
        <div className="col">
          ...
          <img src="../src/assets/liam_chair_ls.webp" alt="image1" className='img-chair top-img'/>
