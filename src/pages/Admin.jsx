...
import "./Admin.css";
import apparatNavbar from "../assets/apparatNavbar.png";
      ...
      <div className="container">
        <div className="row">
          <div className="col-2">
            ...
            <ul>
              <li>
                <button className="adminButton"><i className="bi bi-graph-up-arrow me-3"></i>dashboard</button>
              </li>
              <li>
                <button className="adminButton">products</button>
              </li>
              <li>
                <button className="adminButton">categories</button>
              </li>
              <li>
                <button className="adminButton">orders</button>
              </li>
              <li>
                <button className="adminButton">customers</button>
              </li>
              <hr />
              <li><button className="adminButton">log out</button></li>
            </ul>
          </div>
