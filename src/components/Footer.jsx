  ...
  return (
    <footer>
      <div className="bg-dark text-white">
        <div onClick={() => navigate("/")} className="footer-logo-container">
          <img
            id="footerLogo"
        ...
        <div className="container">
          <div className="row mt-3">
            ...
            <div className="col-sm-12 col-md-3 text-center">
              ...
              <a className="mx-4" href="https://www.facebook.com/" target="blank">
                <svg
              ...
              <a className="mx-4" href="https://twitter.com/home" target="blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <a className="mx-4" href="https://www.instagram.com/" target="blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
